...
class Data_Processer:
	def DataPreprocess():
		infile_list = ['Input_Files/COVID19_Human_Nodes_All.txt', 'Input_Files/Homo_sapiens.GRCh38.101.gtf', 'Input_Files/Homo_sapiens.GRCh38.103.entrez.tsv', 'Input_Files/Severe_Vs_ICU_Significant.txt', 'Input_Files/Severe_Vs_ICU.txt']
