...
DEG_NonDEG_Module().DEG_NonDEG_Count_Module('Output_Files/WGCNA_COVID19_Human_Modules_Clusters.txt', 'Input_Files/Healthy_Vs_Severe.txt', 'Input_Files/Homo_sapiens.GRCh38.103.entrez.tsv', 'Input_Files/Healthy_Vs_Severe_Significant.txt', 'Output_Files/UpDownRegulatedNonDEGs_In_DEGenrichedModules.txt', 'Output_Files/DEG_NonDEG_Module_Pathway.txt')
