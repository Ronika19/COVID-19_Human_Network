...
class Data_Processer:
	def DataPreprocess():
		infile_list = ['Input_Files/COVID19_Human_Nodes_All.txt', 'Input_Files/Homo_sapiens.GRCh38.101.gtf', 'Input_Files/Homo_sapiens.GRCh38.103.entrez.tsv', 'Input_Files/Healthy_Vs_Moderate_Significant.txt', 'Input_Files/Healthy_Vs_Moderate.txt']
		outfile_entrez_list = ['Output_Files/HealthyVsModerate_Significant_EntrezIDs.txt', 'Output_Files/HealthyVsModerate_Up_Significant_EntrezIDs.txt', 'Output_Files/HealthyVsModerate_Down_Significant_EntrezIDs.txt', 'Output_Files/HealthyVsModerate_EntrezIDs.txt']
		outfile_genehandles_list = ['Output_Files/COVID19_Human_NodesAll.txt', 'Output_Files/HealthyVsModerate_Significant_GeneHandles.txt', 'Output_Files/HealthyVsModerate_GeneHandles.txt']
