...
class Data_Processer:
	def DataPreprocess():
		infile_list = ['Input_Files/COVID19_Human_Nodes_All.txt', 'Input_Files/Homo_sapiens.GRCh38.101.gtf', 'Input_Files/Homo_sapiens.GRCh38.103.entrez.tsv', 'Input_Files/Healthy_Vs_ICU_Significant.txt', 'Input_Files/Healthy_Vs_ICU.txt']
		outfile_entrez_list = ['Output_Files/HealthyVsICU_Significant_EntrezIDs.txt', 'Output_Files/HealthyVsICU_Up_Significant_EntrezIDs.txt', 'Output_Files/HealthyVsICU_Down_Significant_EntrezIDs.txt', 'Output_Files/HealthyVsICU_EntrezIDs.txt']
		outfile_genehandles_list = ['Output_Files/COVID19_Human_NodesAll.txt', 'Output_Files/HealthyVsICU_Significant_GeneHandles.txt', 'Output_Files/HealthyVsICU_GeneHandles.txt']
