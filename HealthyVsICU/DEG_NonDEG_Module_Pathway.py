...
from Human_HealthyVsICU_DEG.Nodes_Preprocess import Nodes
from Human_HealthyVsICU_DEG.Upregulated_NonStatistical_DEGs import NonStatistical_DEG
...
DEG_NonDEG_Module().DEG_NonDEG_Count_Module('Output_Files/WGCNA_COVID19_Human_Modules_Clusters.txt', 'Input_Files/Healthy_Vs_ICU.txt', 'Input_Files/Homo_sapiens.GRCh38.103.entrez.tsv', 'Input_Files/Healthy_Vs_ICU_Significant.txt', 'Output_Files/UpDownRegulatedNonDEGs_In_DEGenrichedModules.txt', 'Output_Files/DEG_NonDEG_Module_Pathway.txt')
